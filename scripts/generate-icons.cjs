...
function runAppBuilderIcon(format) {
...
(async () => {
  ...
  // Use electron-builder's native converter for the Windows shell format.
  // Hand-built ICOs containing PNG payloads at every size can make Windows
  // fall back to electron.exe's icon in development and taskbar contexts.
  runAppBuilderIcon('ico');
