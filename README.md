...
| | |
|---|---|
| **217 tools** | Files, shell, git, browser, Docker, screen, keyboard, semantic memory, RAG, notes, calendar, kanban, system, network, audio, image, code analysis, sandboxes, scheduler, workflows |
