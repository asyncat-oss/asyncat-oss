...
export const PROVIDER_CATALOG = [
  ...
  },
  {
    ...
    setup: [
      'Start vLLM with `vllm serve <model>` (defaults to port 8000).',
      'The served model name is the Hugging Face repo id you launched with; use Models to pick it from the list.',
      'vLLM supports OpenAI tool_calls for many models — enable native tools after confirming your model handles them.'
    ],
    description: 'High-throughput local serving through the vLLM OpenAI-compatible server.',
  },
  {
    id: 'jan',
    name: 'Jan',
    ...
    setup: [
      'Enable the Local API Server in Jan (default port 1337).',
      'Load a model in Jan, then pick it from the model list after connecting.'
    ],
    description: 'Use models served by the Jan local API server.',
  },
  {
    id: 'localai',
    name: 'LocalAI',
    ...
    setup: [
      'Run LocalAI (default port 8080); it is a drop-in OpenAI-compatible API.',
      'Model IDs match the model configs installed in LocalAI; pick one from the list after connecting.',
      'LocalAI supports function calling on capable models — enable native tools after testing.'
    ],
    description: 'LocalAI drop-in OpenAI-compatible API for local models.',
  },
  {
    id: 'koboldcpp',
    name: 'KoboldCpp',
    ...
    setup: [
      'Launch KoboldCpp with a GGUF model; its OpenAI-compatible API defaults to port 5001.',
      'The model name reflects the loaded GGUF; select it from the list after connecting.'
    ],
    description: 'Use a local KoboldCpp OpenAI-compatible server.',
  },
  {
    id: 'gpt4all',
    name: 'GPT4All',
    ...
    setup: [
      'Enable the API Server in GPT4All settings (default port 4891).',
      'Load a model in GPT4All, then pick it from the model list after connecting.'
    ],
    description: 'Use models served by the GPT4All local API server.',
  },
  {
    id: 'openai',
    name: 'OpenAI',
  ...
  },
  {
    ...
    description: 'OpenCode Zen curated models via OpenAI-compatible API.',
  },
  {
    id: 'opencode-go',
    name: 'OpenCode Go',
    ...
    description: 'OpenCode Go low-cost open models via OpenAI-compatible API.',
  },
  {
    id: 'mistral',
    name: 'Mistral AI',
