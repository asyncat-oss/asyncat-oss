...
import { Search, X, FolderOpen, MessageSquare, FileText, SquareCheck, Command, Sparkles, Workflow, Cpu, Wrench, Bell, Settings, BrainCircuit, CalendarClock } from 'lucide-react';
...
const COMMANDS = [
  ...
  { id: 'cmd-schedules', label: 'Go to Schedules',      to: '/schedules',    icon: CalendarClock },
