            ...
            <div className="flex-1">
              ...
              <div className="mt-4 p-3 bg-blue-50 dark:bg-blue-900/20 midnight:bg-blue-900/20 rounded-lg">
                ...
                <ul className="text-xs text-blue-700 dark:text-blue-400 midnight:text-blue-400 space-y-1">
                  <li>• Compress the video using online tools</li>
                  <li>• Reduce video resolution or bitrate</li>
                  <li>• Convert to a more efficient format (MP4 H.264)</li>
                </ul>
              </div>
            </div>
          </div>
...
export default VideoUploadAlertModal;
