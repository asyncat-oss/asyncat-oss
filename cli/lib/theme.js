...
export const THEMES = {
  ...
  midnight: {
    name:       'midnight',
    screenBg:   bgRgb(10, 12, 22),
    screenFg:   fgRgb(175, 182, 215),
    panelBg:    bgRgb(16, 19, 34),
    panelFg:    fgRgb(175, 182, 215),
    accent:     fgRgb(125, 165, 255),
    accent2:    fgRgb(100, 215, 195),
    accentBold: `${fgRgb(125, 165, 255)}\x1b[1m`,
    border:     fgRgb(48, 56, 92),
    sugg:       fgRgb(100, 215, 195),
    inputBg:    bgRgb(18, 21, 38),
    inputFg:    fgRgb(200, 205, 232),
    dimBorder:  fgRgb(36, 42, 70),
    highlight:  bgRgb(28, 36, 72),
    statusBg:   bgRgb(8, 10, 18),
    statusFg:   fgRgb(115, 128, 168),
    logoDim:    fgRgb(52, 62, 105),
    logoBright: `${fgRgb(125, 165, 255)}\x1b[1m`,
    paletteSel: bgRgb(26, 34, 74),
    paletteCmd: fgRgb(100, 215, 195),
    msgUser:    fgRgb(125, 165, 255),
    msgAi:      fgRgb(100, 215, 195),
    msgSystem:  fgRgb(115, 128, 168),
    success:    fgRgb(96, 206, 108),
    warning:    fgRgb(230, 185, 95),
    error:      fgRgb(242, 98, 98),
  },
  aurora: {
    name:       'aurora',
